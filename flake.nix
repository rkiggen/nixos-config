{
    ...
    inputs = {
        ...
        nixpkgs-for-nixos-l241214a.url = "github:nixos/nixpkgs/nixos-26.05";

        # Stable, general purpose
        nixpkgs-from-stable-l231028a.url = "github:nixos/nixpkgs/nixos-24.05";
        nixpkgs-from-stable-l241214a.url = "github:nixos/nixpkgs/nixos-26.05";
        ...
        nixpkgs-for-rider-l241214a.url = "github:nixos/nixpkgs/nixos-26.05"; 
