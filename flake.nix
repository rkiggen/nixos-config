{
  ...
  inputs = { 							
    ...
    nixpkgs-for-nixos-l231028a.url = "github:nixos/nixpkgs/nixos-23.05";

    # Stable, general purpose
    nixpkgs-from-stable-l211008a.url = "github:NixOS/nixpkgs/nixos-23.05";
    nixpkgs-from-stable-l231028a.url = "github:NixOS/nixpkgs/nixos-23.05";
    ...
    nixpkgs-for-rider-l231028a.url = "github:nixos/nixpkgs/nixos-23.05"; # Rider 2023.1.2

    # Home-manager
    home-manager-l211008a.url = "github:nix-community/home-manager/release-23.05";
    home-manager-l231028a.url = "github:nix-community/home-manager/release-23.05";
