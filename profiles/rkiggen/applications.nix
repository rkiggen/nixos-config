{ nixpkgs, ... }: {
  ...
  home.packages = [
    ...
    nixpkgs.from.stable.filezilla 					# ftp client
    ...
    nixpkgs.from.stable.mc						# midnight commander - cli file manager
    ...
    nixpkgs.from.stable.quickemu					# quickly create and run optimised Windows, macOS and Linux virtual machines
